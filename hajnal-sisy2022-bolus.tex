...
of the acceleration data a calm period was selected with length of 36 sec.
Fig. \ref{bolus-gw-photo} shows the selected signal in time domain.

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{fig/heart-time-domain.jpg}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{fig/heart-wavelet.jpg}}
