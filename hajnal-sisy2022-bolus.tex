...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{fig/bolus-physical-layout.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{fig/bolus_gw_photo.jpg}}
...
\begin{figure}[htbp]
\centerline{
  \includegraphics[width=0.18\textwidth]{fig/kfj_1.png}
  \includegraphics[width=0.18\textwidth]{fig/kfj_2.png}
  \includegraphics[width=0.18\textwidth]{fig/kfj_3.png}
  }
  \caption{The bolus (right side) and the gateway (left side).}
\label{bolus-gw-photo}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{fig/bolus_application.jpg}}
